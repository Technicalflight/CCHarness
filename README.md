...
- 当前版本 v0.2.0，处于快速迭代期；
- 完整版本更新日志见官网指南的 [更新日志](https://technicalflight.github.io/CCHarness/guide/changelog.html) 页面，或 [GitHub Releases](https://github.com/Technicalflight/CCHarness/releases)；
